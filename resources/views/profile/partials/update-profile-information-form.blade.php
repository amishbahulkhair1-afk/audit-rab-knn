    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-8 space-y-6">
        ...
        <div>
            ...
            <input id="name" name="name" type="text" value="{{ old('name', $user->name) }}" required
                ...
                class="block w-full rounded-xl bg-slate-50 border border-slate-300 px-4 py-3 text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
        ...
        <div>
            ...
            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && !$user->hasVerifiedEmail())
                ...
                <div class="mt-5 p-5 rounded-2xl bg-amber-50 border border-amber-200">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-amber-800 leading-relaxed">
                                ...
                                <button form="send-verification"
                                    class="block mt-2 text-amber-900 font-bold underline hover:text-amber-700">
        ...
        <div class="flex items-center gap-4 pt-3">
            ...
            <button type="submit"
                class="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-xl shadow-sm hover:shadow-md transition text-xs font-bold uppercase tracking-wider">

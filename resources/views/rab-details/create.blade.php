                ...
                <form action="{{ route('rab-details.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="space-y-1.5">
                        <label class="block text-[10px] font-bold text-slate-700 uppercase tracking-wider">
                            {{ __('Pilih AHSP') }} <span class="text-rose-500 font-bold ml-0.5" title="Wajib diisi">*</span>
                        </label>
                        <select name="ahsp_id"
                    ...
                    <div class="space-y-1.5">
                        <label class="block text-[10px] font-bold text-slate-700 uppercase tracking-wider">
                            {{ __('Volume') }} <span class="text-rose-500 font-bold ml-0.5" title="Wajib diisi">*</span>
                        </label>
                        <input type="number" step="0.01" name="volume" required placeholder="0.00"
                            class="w-full rounded-lg border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                    </div>

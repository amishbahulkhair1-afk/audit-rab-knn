...
<div class="py-6">
    ...
    <form method="POST"
          action="{{ route('ahsp-details.store') }}"
          class="bg-white p-6 rounded shadow"
          v-data="{ jenisTerpilih: '' }"> <!-- Menggunakan attribute reaktif Vue internal di elemen jika diisi via app.js -->
        ...
        <div class="mb-4">
            ...
            <input type="text"
                   value="{{ $ahsp->kode }} - {{ $ahsp->nama_pekerjaan }}"

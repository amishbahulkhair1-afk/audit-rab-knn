                ...
                <div class="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div class="max-w-2xl">
                            ...
                            <h1 class="text-2xl md:text-3xl font-bold leading-tight">
                                Daftar Data Material
                            </h1>

                            <p class="text-sm md:text-base text-white/80 mt-3 leading-relaxed">
                                Kelola seluruh data material pendukung pekerjaan konstruksi beserta satuan dan harga satuan
                                yang
                                digunakan pada penyusunan AHSP dan RAB.
                            </p>
                    ...
                    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 lg:justify-end lg:self-start">
                        ...
                        <a href="{{ route('materials.create') }}"
                            class="inline-flex items-center justify-center gap-2 rounded-2xl bg-white text-indigo-600 px-4 py-2.5 text-sm font-semibold shadow-lg hover:bg-slate-100 transition whitespace-nowrap">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500 mt-1">
                            Unggah file Excel untuk menambahkan data material secara massal.
                        </p>
                    </div>
    ...
    ========================================== --}}
            <div class="glass-surface rounded-3xl overflow-hidden">
                ...
                <div class="px-5 py-4 border-b border-slate-200/70 flex items-center justify-between">
                    ...
                    <div>
                        <h2 class="text-lg font-semibold text-slate-900">Data Material</h2>
                        <p class="text-sm text-slate-500 mt-1">
                            Total {{ $materials->total() }} material tersedia dalam sistem.
                        </p>
                    </div>
                    ...
                    <table class="min-w-full text-sm text-left text-slate-700">
                        ...
                        <thead class="bg-slate-50/80 text-xs font-semibold uppercase tracking-wide text-slate-500">
                            ...
                            <tr>
                                ...
                                <th class="px-6 py-4 w-40">Satuan</th>
                                <th class="px-6 py-4 w-52">Harga Satuan</th>
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-slate-500 mt-1">
                                                    {{ $material->kode ?? 'M' . str_pad($material->id, 3, '0', STR_PAD_LEFT) }}
                                                </p>
                                        ...
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <a href="{{ route('materials.edit', $material->id) }}"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none"
                                                    viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                        d="M11 5h2m-1-2v4m6 10l-7 4-7-4m14 0V7l-7-4-7 4v10" />
                                                </svg>
                                            ...
                                            <form action="{{ route('materials.destroy', $material->id) }}" method="POST"
                                                onsubmit="return confirm('Hapus data material ini?')">
                                        ...
                                        <div class="flex flex-col items-center justify-center gap-3 text-slate-400">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-slate-400 mt-1">
                                                    Tambahkan material baru untuk mulai mengelola data.
                                                </p>

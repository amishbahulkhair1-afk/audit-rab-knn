    ...
    <x-slot name="header">
        <div class="flex items-center justify-between w-full">
            ...
            <a href="{{ route('materials.index') }}"
                class="inline-flex items-center px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl shadow-sm transition">
        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm rounded-xl border border-slate-100 overflow-hidden">
                ...
                <div class="px-6 py-5 bg-slate-50 border-b border-slate-100 flex justify-between items-center">
                    ...
                    <span
                        class="px-3 py-1.5 text-xs font-semibold rounded-lg bg-indigo-50 text-indigo-700 border border-indigo-100">
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="bg-slate-50 rounded-xl border border-slate-100 p-5">
                            ...
                            <span
                                class="inline-flex mt-2 px-3 py-1 text-xs font-semibold bg-white border border-slate-200 rounded-lg text-slate-700">
                        ...
                        <div class="md:col-span-2 bg-slate-50 rounded-xl border border-slate-100 p-5">
                ...
                <div class="px-6 py-4 bg-slate-50 border-t border-slate-100 flex justify-end gap-3">
                    ...
                    <a href="{{ route('materials.edit', $material->id) }}"
                        class="px-4 py-2 bg-amber-500 hover:bg-amber-600 text-white text-sm font-semibold rounded-lg shadow-sm transition">
                    ...
                    <form action="{{ route('materials.destroy', $material->id) }}" method="POST"
                        ...
                        <button type="submit"
                            class="px-4 py-2 bg-rose-500 hover:bg-rose-600 text-white text-sm font-semibold rounded-lg shadow-sm transition">

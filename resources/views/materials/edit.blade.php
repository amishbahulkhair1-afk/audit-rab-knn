<x-app-layout>
    ...
    <div class="space-y-5">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <h1 class="text-xl md:text-2xl font-bold leading-tight">
                            Edit: {{ $material->nama_bahan }}
                        </h1>
                        <p class="text-xs md:text-sm text-white/80 mt-1">
                            Perbarui informasi harga dan spesifikasi bahan material.
                        </p>
                    </div>
        ...
        <div class="glass-surface rounded-3xl overflow-hidden p-6 md:p-8">
            ...
            <form action="{{ route('materials.update', $material->id) }}" method="POST" class="space-y-6 max-w-3xl">
                ...
                <div>
                    ...
                    <input type="text" name="nama_bahan" value="{{ old('nama_bahan', $material->nama_bahan) }}"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="harga_satuan"
                                value="{{ old('harga_satuan', $material->harga_satuan) }}" min="0" placeholder="0"
                ...
                <div>
                    ...
                    <textarea name="keterangan" rows="3" placeholder="Tambahkan detail atau spesifikasi material (opsional)..."
                        class="w-full rounded-2xl border border-slate-200 bg-white/70 px-4 py-3 text-sm text-slate-800 shadow-sm focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200/50 outline-none transition">{{ old('keterangan', $material->keterangan) }}</textarea>
                    @error('keterangan')
                        <p class="text-xs text-rose-600 mt-1.5 font-medium">{{ $message }}</p>
                    @enderror
                </div>

    ...
    <div class="space-y-5">
            ...
            <div class="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="max-w-2xl">
                        ...
                        <h1 class="text-2xl md:text-3xl font-bold leading-tight">
                            Daftar Data Tenaga Kerja
                        </h1>

                        <p class="text-sm md:text-base text-white/80 mt-3 leading-relaxed">
                            Kelola seluruh data tenaga kerja dan standar upah yang digunakan
                            pada penyusunan AHSP dan Rencana Anggaran Biaya.
                        </p>
                ...
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 lg:justify-end lg:self-start">
                    ...
                    <a href="{{ route('labors.create') }}"
                        class="inline-flex items-center justify-center gap-2 rounded-2xl bg-white text-rose-600 px-4 py-2.5 text-sm font-semibold shadow-lg hover:bg-slate-100 transition whitespace-nowrap">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-500 mt-1">
                        Unggah file Excel untuk menambahkan data tenaga kerja secara massal.
                    </p>
                </div>
        ...
        <div class="glass-surface rounded-3xl overflow-hidden">
            ...
            <div class="px-5 py-4 border-b border-slate-200/70 flex items-center justify-between">
                ...
                <div>
                    <h2 class="text-lg font-semibold text-slate-900">Data Tenaga Kerja</h2>
                    <p class="text-sm text-slate-500 mt-1">
                        Total {{ $labors->total() }} tenaga kerja tersedia dalam sistem.
                    </p>
                </div>
                ...
                <table class="min-w-full text-sm text-left text-slate-700">
                    ...
                    <thead class="bg-slate-50/80 text-xs font-semibold uppercase tracking-wide text-slate-500">
                        ...
                        <tr>
                            ...
                            <th class="px-6 py-4 w-48">Upah Harian</th>
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        @forelse($labors as $labor)
                            <tr class="hover:bg-white/60 transition">
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        class="inline-flex items-center rounded-lg bg-slate-100 px-3 py-1 text-xs font-bold text-slate-700 border border-slate-200 font-mono">
                                        {{ $labor->kode }}
                                    </span>
                                </td>

                                <td class="px-6 py-4">
                                    <div class="font-semibold text-slate-900">{{ $labor->nama_pekerja }}</div>
                                    <div class="text-xs text-slate-400 mt-0.5">Tenaga kerja konstruksi</div>
                                </td>

                                <td class="px-6 py-4">
                                    <span
                                        class="inline-flex items-center rounded-lg bg-indigo-50 px-3 py-1 text-xs font-semibold text-indigo-700 border border-indigo-100">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <form action="{{ route('labors.destroy', $labor->id) }}" method="POST"
                                            onsubmit="return confirm('Hapus data pekerja ini?')">
                            ...
                            <tr>
                                ...
                                <td colspan="4" class="px-6 py-16 text-center">
                                    ...
                                    <div class="flex flex-col items-center justify-center gap-3 text-slate-400">
                                        ...
                                        <div>
                                            <p class="font-medium text-slate-500">Belum ada data tenaga kerja</p>
                                            <p class="text-sm text-slate-400 mt-1">Tambahkan pekerja baru atau import dari Excel.</p>
                                        </div>

<x-app-layout>
    ...
    <div class="py-10">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-5">
            ...
            @if (session('success'))
                <div
                    class="flex items-center gap-3 p-4 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-700 text-sm">
                            ...
                            @forelse($labors as $labor)
                                <tr class="hover:bg-slate-50 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <span
                                            class="inline-flex px-3 py-1 rounded-lg bg-slate-100 text-slate-700 border border-slate-200 text-xs font-bold">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <span
                                            class="inline-flex px-3 py-1 rounded-lg bg-indigo-50 text-indigo-700 border border-indigo-100 font-semibold text-xs">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="flex justify-center gap-2">
                                            ...
                                            <a href="{{ route('labors.show', $labor->id) }}"
                                                class="px-3 py-1.5 rounded-lg bg-slate-50 text-slate-700 border border-slate-200 text-xs font-semibold hover:bg-slate-100">
                                            ...
                                            <a href="{{ route('labors.edit', $labor->id) }}"
                                                class="px-3 py-1.5 rounded-lg bg-amber-50 text-amber-700 border border-amber-200 text-xs font-semibold hover:bg-amber-100">
                                            ...
                                            <form action="{{ route('labors.destroy', $labor->id) }}" method="POST">
                                                ...
                                                <button type="submit"
                                                    ...
                                                    class="px-3 py-1.5 rounded-lg bg-rose-50 text-rose-600 border border-rose-200 text-xs font-semibold hover:bg-rose-100">

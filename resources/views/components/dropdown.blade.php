...
<div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-200"
        ...
        <!-- Mengubah rounded-md menjadi rounded-xl agar sudutnya lebih melengkung modern -->
        <div class="rounded-xl ring-1 ring-black ring-opacity-5 p-1.5 {{ $contentClasses }}">
            {{ $content }}
        </div>
    </div>
</div>

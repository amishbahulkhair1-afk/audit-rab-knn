<x-app-layout>
    ...
    <div class="space-y-5">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <h1 class="text-xl md:text-2xl font-bold leading-tight">
                            Tambah Data Latih KNN
                        </h1>
                        <p class="text-xs md:text-sm text-white/80 mt-1">
                            Input data sampel bangunan dan nilai kondisi komponen untuk melatih algoritma K-NN.
                        </p>
                    </div>
        ...
        <div class="glass-surface rounded-3xl overflow-hidden p-6 md:p-8">
            ...
            <form action="{{ route('data-set.store') }}" method="POST" class="space-y-8">

<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <a href="{{ route('audits.index') }}"
                    class="inline-flex items-center gap-2 bg-slate-100 hover:bg-slate-200 text-slate-700 px-4 py-2 rounded-xl text-sm font-medium transition">
        ...
        {{-- ERROR ALERT --}}
        @if ($errors->any())
            <div class="bg-rose-50 border border-rose-200 text-rose-700 rounded-xl p-5 shadow-sm">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100">
            ...
            <form action="{{ route('audits.store') }}" method="POST" class="p-6 md:p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <label class="text-sm font-semibold text-slate-700">
                                Tanggal Audit <span class="text-rose-500 font-bold ml-0.5" title="Wajib diisi">*</span>
                            </label>
                        ...
                        <div>
                            ...
                            <label class="text-sm font-semibold text-slate-700">
                                Pilih Bangunan <span class="text-rose-500 font-bold ml-0.5" title="Wajib diisi">*</span>
                            </label>
                    ...
                    @foreach ($komponen as $field => $label)
                        <div class="bg-slate-50 rounded-xl border border-slate-100 p-4">
                            ...
                            <label class="block text-sm font-semibold text-slate-700 mb-2">
                                ...
                                {{ $label }} <span class="text-rose-500 font-bold ml-0.5" title="Wajib diisi">*</span>

                            </label>

                            <select name="{{ $field }}" class="w-full rounded-lg border-slate-300">
                ...
                <div class="mt-6">
                    ...
                    <textarea name="catatan" rows="4" class="mt-2 w-full rounded-xl border-slate-300"
                ...
                <div class="mt-8 pt-5 border-t flex justify-end gap-3">
                    ...
                    <a href="{{ route('audits.index') }}"
                        class="px-5 py-2 bg-slate-100 hover:bg-slate-200 rounded-xl text-sm">
                    ...
                    <button type="submit"
                        class="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-sm font-semibold">

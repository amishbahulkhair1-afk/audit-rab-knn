            ...
            <div class="mx-auto w-full max-w-sm lg:w-96">
                ...
                <div class="mt-8">
                    <form method="POST" action="{{ route('login') }}" class="space-y-5">
                        ...
                        <!-- Input Email -->
                        <div>
                            <label for="email" class="block text-sm font-medium text-slate-900">Email <span class="text-rose-500 font-bold ml-0.5" title="Wajib diisi">*</span></label>
                            <div class="mt-2">
                        ...
                        <div>
                            <div class="flex items-center justify-between">
                                <label for="password" class="block text-sm font-medium text-slate-900">Password <span class="text-rose-500 font-bold ml-0.5" title="Wajib diisi">*</span></label>

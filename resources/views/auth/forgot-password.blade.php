        ...
        <div class="relative hidden lg:flex flex-col justify-between bg-slate-900 p-10 text-white overflow-hidden">
            ...
            <div class="relative z-10 max-w-lg mb-6">
                ...
                <p class="text-slate-300 text-sm leading-relaxed">
                    ...
                    Gunakan email terdaftar untuk mendapatkan tautan reset password dan kembali mengakses Sistem Audit
                    Bangunan.
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                ...
                                <input id="email" name="email" type="email" autocomplete="email" required
                                    autofocus value="{{ old('email') }}" placeholder="nama@email.com"

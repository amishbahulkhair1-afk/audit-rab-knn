                ...
                <form action="{{ route('buildings.update', $building) }}" method="POST" class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="alamat" rows="4"
                                class="mt-2 w-full rounded-xl border-slate-200 focus:border-emerald-500 focus:ring-emerald-500">{{ old('alamat', $building->alamat) }}</textarea>
                    ...
                    <div class="mt-8 pt-5 border-t border-slate-100 flex justify-end gap-3">
                        ...
                        <a href="{{ route('buildings.index') }}"
                            class="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-slate-100 text-slate-700 font-semibold hover:bg-slate-200 transition">

                ...
                <form action="{{ route('equipments.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" id="nama_alat" name="nama_alat" value="{{ old('nama_alat') }}"
                            placeholder="Contoh: Ekskavator Mini, Palu Gada, dll."
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="space-y-1.5 md:col-span-1">
                            <label for="satuan"
                                class="text-xs font-bold text-slate-700 uppercase tracking-wide block">
                        ...
                        <div class="space-y-1.5 md:col-span-2">
                            ...
                            <div class="relative rounded-lg shadow-xs">
                                ...
                                <input type="number" id="harga_satuan" name="harga_satuan"
                                    value="{{ old('harga_satuan') }}" placeholder="0" min="0"

                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-slate-50 border-b border-slate-100">
                            <th class="px-6 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-wider">Nomor Audit
                            </th>
                            <th class="px-6 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-wider">Bangunan
                            </th>
                            ...
                            <th class="px-6 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-wider text-center">
                                Aksi</th>
                        </tr>
                    </thead>
                        ...
                        @forelse ($audits as $audit)
                            <tr class="hover:bg-slate-50 transition">
                                ...
                                <td class="px-6 py-4 text-sm text-slate-600">
                                    {{ \Carbon\Carbon::parse($audit->tanggal_audit)->format('d M Y') }}</td>
                                <td class="px-6 py-4 text-sm">
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-medium bg-emerald-50 text-emerald-800">
                                        {{ $audit->hasil_knn }}
                                    </span>
                                </td>

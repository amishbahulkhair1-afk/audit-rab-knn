...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="{{ route('rabs.create') }}" class="bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2 rounded-xl font-semibold transition shadow-sm">
        + Tambah RAB
    </a>
</div>
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50 transition">
                    ...
                    <td class="px-6 py-4 text-slate-600">{{ \Carbon\Carbon::parse($rab->tanggal_rab)->format('d M Y') }}</td>
                    <td class="px-6 py-4 font-semibold text-emerald-600">Rp {{ number_format($rab->total_biaya, 0, ',', '.') }}</td>
